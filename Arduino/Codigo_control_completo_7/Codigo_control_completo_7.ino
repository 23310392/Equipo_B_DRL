...
// --- ASIGNACIÓN DE MOTORES (QUAD X) para Arduino Nano ESP32 ---
const int pinMotor1 = D2; // Trasero Derecho (CCW)
const int pinMotor2 = D3; // Frontal Derecho (CW)
const int pinMotor3 = D4; // Trasero Izquierdo (CW)
const int pinMotor4 = D5; // Frontal Izquierdo (CCW)

Servo esc1, esc2, esc3, esc4;

// --- VARIABLES DE ESTADO Y SEGURIDAD ---
enum DroneState { INICIANDO_ESCS, SUELO, DESPEGANDO, VOLANDO, ATERRIZANDO };
